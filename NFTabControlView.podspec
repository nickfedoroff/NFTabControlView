#
#  Be sure to run `pod spec lint NFTabControlView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Tab control like UISegmentedControl with more pizazz."
  ...
  s.source       = { :git => "http://EXAMPLE/NFTabControlView.git", :tag => "#{s.version}" }
